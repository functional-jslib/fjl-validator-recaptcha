...
const
    ...
    updateMethodByArity = (moduleMeta, memberName, topLevelNamesByArity) => {
        const arity = moduleMeta.module[memberName].length,
            {methodNamesByArity} = moduleMeta;
        if (typeof moduleMeta.module[memberName] === 'string') {
            moduleMeta.properties.push(memberName);
            return;
        }
        ...
        topLevelNamesByArity[arity].push(memberName);
        methodNamesByArity[arity].push(memberName);
    },
