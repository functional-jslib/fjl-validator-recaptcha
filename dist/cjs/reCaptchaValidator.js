 ...
 * @type {string}
 */
MISSING_INPUT_SECRET = exports.MISSING_INPUT_SECRET = 'missing-input-secret',
 ...
 * @type {string}
 */
INVALID_INPUT_SECRET = exports.INVALID_INPUT_SECRET = 'invalid-input-secret',
 ...
 * @type {string}
 */
MISSING_INPUT_RESPONSE = exports.MISSING_INPUT_RESPONSE = 'missing-input-response',
 ...
 * @type {string}
 */
INVALID_INPUT_RESPONSE = exports.INVALID_INPUT_RESPONSE = 'invalid-input-response',
 ...
 * @type {string}
 */
BAD_REQUEST = exports.BAD_REQUEST = 'bad-request',
 ...
 * @type {string}
 */
UNKNOWN_ERROR = exports.UNKNOWN_ERROR = 'unknown-error',
 ...
 */
toReCaptchaValidatorOptions = exports.toReCaptchaValidatorOptions = function toReCaptchaValidatorOptions(options) {
 ...
 * @returns {void}
 */
makeReCaptchaRequest$ = exports.makeReCaptchaRequest$ = function makeReCaptchaRequest$(options, value, resolve, reject) {
    var messages = [],
        secret = value.secret,
    ...
    var formParams = { secret: secret, remoteip: remoteip, response: response },
        requestOptions = options.requestOptions,
        serializedParams = _querystring2.default.stringify(formParams);
    ...
    var validationResult = (0, _fjlValidator.toValidationResult)(),
        request = _https2.default.request(requestOptions, function (res) {
        // handle `response` (`res`)
        var body = '';
 ...
 * @returns {void}
 */
reCaptchaValidator$ = exports.reCaptchaValidator$ = function reCaptchaValidator$(options, value, resolve, reject) {
 ...
 */
reCaptchaIOValidator$ = exports.reCaptchaIOValidator$ = function reCaptchaIOValidator$(options, value) {
 ...
 * @curried - Is curried.
 */
reCaptchaIOValidator = exports.reCaptchaIOValidator = (0, _fjl.curry)(reCaptchaIOValidator$),
 ...
 * @curried - Is curried.
 */
reCaptchaValidator = exports.reCaptchaValidator = reCaptchaIOValidator,
